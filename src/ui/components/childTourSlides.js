...
export const CHILD_TOUR_SLIDES = [
  ...
  },
  {
    ...
    body: t('The tiles show how many apps are blocked, how many are waiting on parent approval, and how many requests you have in progress. Tap any tile to see the details.'),
    targetId: 'child-home-tiles',
    navigate: nav('home'),
  },
  {
    title: t('Need more time?'),
    body: t('When an app is blocked or you\'ve hit your daily limit, tap Request on the block screen to ask your parent. They get a notification and can approve from their device.'),
    navigate: nav('home'),
  },
  {
    title: t('Quick override with a PIN'),
    body: t('If your parent set up a PIN, you can enter it on the block screen for a short override without waiting for approval. Each use is logged.'),
    navigate: nav('home'),
    cta: t('Got it'),
  },
];
